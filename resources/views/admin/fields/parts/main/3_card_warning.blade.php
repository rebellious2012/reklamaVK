<div class="card card-warning card-outline">
    <div class="card-header">
        <h3 class="card-title">Дії з Полями</h3>
...
{{--            </a>--}}
                <a href="{{route('fields.create')}}" class="btn btn-app bg-success"> <i class="fas fa-user-plus"></i> Додати Поле</a>
{{--        @endcan--}}
{{--        @can('access-page', 'users_edit')--}}
            <a class="btn btn-app bg-warning edit-link" href="#" data-base-url="/admin/fields">
