<div class="card card-warning card-outline">
    <div class="card-header">
        <h3 class="card-title">Дії з Кроками</h3>
...
{{--            </a>--}}
                <a href="{{route('steps.create')}}" class="btn btn-app bg-success"> <i class="fas fa-user-plus"></i> Додати Крок</a>
{{--        @endcan--}}
{{--        @can('access-page', 'users_edit')--}}
            <a class="btn btn-app bg-warning edit-link" href="#" data-base-url="/admin/steps">
