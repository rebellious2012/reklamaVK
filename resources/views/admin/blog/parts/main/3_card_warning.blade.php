<div class="card card-warning card-outline">
    <div class="card-header">
        <h3 class="card-title">Дії з Новинами</h3>
...
{{--            <i class="fas fa-info-circle"></i> Інформація про Етап--}}
{{--        </a>--}}
...
{{--            </a>--}}
                <a href="{{route('blogs.create')}}" class="btn btn-app bg-success"> <i class="fas fa-user-plus"></i> Додати Новину</a>
{{--        @endcan--}}
{{--        @can('access-page', 'users_edit')--}}
            <a class="btn btn-app bg-warning edit-link" href="#" data-base-url="/admin/blogs">
