...
@section('content')
    ...
    @include('admin.stages.parts.header.index')

    @include('admin.stages.parts.main.index')
...
<script>
    ...
    $('.button-delete').on('click', function() {
        ...
        if(id){
            ...
            modal.find('form').attr('action', '/admin/stages/' + id );
        }else{
            alert(select_user);
            return false;
        }
    ...
    // $(function () {
        $(document).ready(function() {
            var table = $("#example1").DataTable({
                ...
                "lengthChange": false,
                "autoWidth": false,
                "order": [[1, "asc"]], // Сортировка по второму столбцу (position) по возрастанию
